...
xrun -compile -64bit ${curdir}/../pkg/cache_pkg.sv ${curdir}/../rtl/single_port_ram.sv ${curdir}/../rtl/cache_top.sv ${curdir}/../tb/tb_configure_cache.sv \
    ...
    ${curdir}/../rtl/hit_miss_detect.sv ${curdir}/../rtl/mshr.sv ${curdir}/../rtl/cache_data_read.sv \
